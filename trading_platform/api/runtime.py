...
class TradingRuntime:
    ...
    async def _on_fill(self, trade, intent: OrderIntent) -> None:
        ...
        try:
            # Attach market feature_vector at fill time so pgvector can later
            # retrieve trades similar to any given market state.
            _fv: list | None = None
            try:
                ...
                pass
            self.db.save_trade(trade, execution_mode=exec_mode, feature_vector=_fv)
